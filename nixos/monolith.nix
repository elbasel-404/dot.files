...
# Generated on Sun Jul 13 12:13:30 PM EEST 2025
...
# BEGIN /home/elbasel/config/nixos/modules/power.nix
{
  ...
  # This option allows you to provide additional configuration settings for the logind service.
  # logind is systemd's login manager, responsible for handling user logins, sessions, and power management events.
  # The string provided to `extraConfig` is appended to the logind.conf file.
  # In this case, "RuntimeDirectorySize=12G" increases the size of the runtime directory for users to 12GB.
  # "HandleLidSwitchDocked=ignore" tells logind to ignore lid switch events when the system is docked.
  ...
  # This option enables the auto-cpufreq service.
